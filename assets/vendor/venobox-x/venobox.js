...
(function($){
    ...
    var autoplay, bgcolor, blockleft, blocknum, blockshare, blocktitle, border, core, container, content, dest, extraCss,
        ...
        share, sharelinks, vbfooter, sharepos, imgitem;
            ...
            return this.each(function() {
                ...
                */
                ...
                function updateoverlay(){
                    ...
                    // var imgname = $('#' + imgitem).find(".portfolio-info h4").text();
                    // var imgdesc = $('#' + imgitem).find(".portfolio-info p").text();
                    var imginfo = $('#' + imgitem).find(".portfolio-info").html();
//                    blocktitle.html('<h5>' + imgname + '</h5><p>' + imgdesc + '</p>');
                    blocktitle.html(imginfo);
